...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.9iel3.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
...
client.connect((err) => {
  ...
  app.post("/productByKyes", (req, res) => {
